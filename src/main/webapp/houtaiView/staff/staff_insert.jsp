...
<html>
	...
	<head>
		...
		<!-- Data Tables -->
		<link href="${ctx}/static/houtai/css/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet">
	...
	<body class="gray-bg">
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<form id="insertform" onsubmit="return doinsert()" name="updatefrom" class="form-horizontal">
							
							<div class="form-group">
								<input type="hidden" class="form-control" id="staff_id" required="" name="staffId">
							</div>

							<div class="form-group">
								<label class="col-sm-2 control-label">姓名</label>
								<div class="col-sm-10">
									<input type="text" placeholder="请输入姓名" class="form-control" id="staff_name" required="" name="staffName"
									 required="required">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10"><input type="text" placeholder="请输入账号" class="form-control" name="staffLoginName"
								id="staff_login_name" required="required"></div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10"><input type="text" placeholder="请输入密码" class="form-control" id="staff_password"
								 name="staffPassword" required="required"></div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
								<input type="number" placeholder="请输入年龄" class="form-control"
								 id="staff_age" name="staffAge">
								 </div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
								<div class="radio"><label> <input type="radio" id="staff_sex_woman" value="女"
									 name="staffSex" checked=""/>女
								</label> 
								</div>
								<div class="radio"><label> <input type="radio" value="男" name="staffSex" id="staff_sex_man" />男
								</label>
								</div></div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">所属网点</label>
								 <div class="col-sm-10">
								 <input type="text" required="" placeholder="请输入网点" class="form-control"
								 id="dot_name" name="dotName" required="required">
								 </div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
								<input type="date" required="" placeholder="请输入职位" class="form-control"
						...
						<!-- 	<div class="form-group">
								<label class="col-sm-2 control-label">工资</label>
								 <div class="col-sm-10">
								 <input type="number" placeholder="" class="form-control" step="0.01"
								 id="sal" name="sal" min:0 />
								 </div>
							</div> -->
							...
							<div class="form-group">
								...
								<input type="number" required="required" placeholder="请输入电话号码"
								 class="form-control" name="staffPhone" id="staff_phone" required="required">
								 </div>
							</div>
		...
		<script src="${ctx}/static/houtai/js/plugins/dataTables/dataTables.bootstrap.js"></script>
		...
		// jquery 表单提交
			$.post(getContextPath()+"/houtai/staff/doinsert.do",formJSON,function(msg){ 
				console.log(msg);
				if(msg == 1){
